...
public class PolicyService {
    ...
    public UUID createDraft(
        ...
        var coverage = new Coverage(coverageType, coverageLimit);
        var premium = underwriting.calculatePremium(coverage);

        var policy = Policy.draftNew(customerId, coverage, premium, start, end);
