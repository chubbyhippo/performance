...
public class Policy {
  ...
  @Embedded private Coverage coverage;

  @Embedded private Money premium;
  ...
  public static Policy draftNew(
      String customerId, Coverage coverage, Money premium, LocalDate startDate, LocalDate endDate) {
